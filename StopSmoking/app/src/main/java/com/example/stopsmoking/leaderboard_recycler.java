...
public class leaderboard_recycler extends AppCompatActivity {
    ...
    private void initData() {
        ...
        versionsList.add(new Versions("2. Michael Jordan", "011-4672567", "Level 9", "No smoking for more than 8 days"));
        versionsList.add(new Versions("3. Elon Musk", "Unknown", "Level 6", "No smoking for more than 5 days"));
        versionsList.add(new Versions("4. John Snow", "255 2233222", "Level 5", "No smoking for more than 4 days"));
        versionsList.add(new Versions("5. Stark", "016 4788929", "Level 3", "No smoking for 3 days"));
        versionsList.add(new Versions("6. Alice", "012 8589367", "Level 1", "Just started"));
    }
